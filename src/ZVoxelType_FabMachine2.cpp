...
void ZVoxelType_FabMachine2::GetBlockInformations(ZVoxelLocation * DestLocation, ZString & Infos)
{
...
void ZVoxelType_FabMachine2::GetScanInformations(ZVoxelCoords * VoxelCoords, UShort VoxelType, ZMemSize VoxelInfo, ZString & Inf)
{
  ULong i;
  UShort Voxel;
  ZVoxelType * VoxelT;
