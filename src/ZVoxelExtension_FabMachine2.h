...
class ZVoxelExtension_FabMachine2 : public ZVoxelExtension
{
  ...
  {
    ZVoxelExtension_FabMachine2 * NewCopy;
    NewCopy = new ZVoxelExtension_FabMachine2(*this);
    return(NewCopy);
  }

  ZVoxelExtension_FabMachine2()
  {
    ULong i;
    ExtensionType = Extension_FabMachine2;
    LastInDirection = 0;
    MachineState = 0;
