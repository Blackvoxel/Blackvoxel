...
struct SQVM : public CHAINABLE_OBJ
{
        ...
        bool StopVM;
        bool IsRunning;
inline  bool IsRunningProgram() { return(IsRunning); }
inline  bool IsVMStopped()      { return(StopVM);}
inline  void ForceVMStop(bool StopStatus = true) {StopVM = StopStatus; }
inline  void SetRunning(bool RunningStatus = true) {IsRunning = RunningStatus;}

        // *** End Blackvoxel Modding ***
