...
// Dev options forced ?
  ...
  #define DEVELOPPEMENT_ON 0 // If you are making development, set it to 1
#endif

#ifndef COMPILEOPTION_DEMO
  #  define COMPILEOPTION_DEMO 0
  #endif
#define COMPILEOPTION_VERSIONNUM 134
...
// Version de démo
    ...
    #define COMPILEOPTION_VERSIONSTRING "VERSION DEMO 1.34 (c) 2014 LAURENT THIEBAUT & OLIVIA MERLE"
  #else
    #define COMPILEOPTION_INVENTORY_DEMOCONTENT 0
    #define COMPILEOPTION_ALLOWSAVE 1
    #define COMPILEOPTION_ALLOWSAVEPLAYERSTATE 1
    #define COMPILEOPTION_ALLOWVEHICLE 1
    #define COMPILEOPTION_VERSIONSTRING "VERSION 1.34 (c) 2014 LAURENT THIEBAUT & OLIVIA MERLE"
  #endif
#else
  #define COMPILEOPTION_INVENTORY_DEMOCONTENT 0
  #define COMPILEOPTION_ALLOWSAVE 0
  #define COMPILEOPTION_ALLOWSAVEPLAYERSTATE 0
  #define COMPILEOPTION_ALLOWVEHICLE 1
  #define COMPILEOPTION_VERSIONSTRING "VERSION 1.34 : CONFIDENTIAL TESTING (c) LAURENT THIEBAUT & OLIVIA MERLE"
#endif
