...
// Dev options forced ?
  ...
  #endif
#define COMPILEOPTION_VERSIONNUM 136
...
// Version de démo
    ...
    #define COMPILEOPTION_VERSIONSTRING "VERSION DEMO 1.36 (c) 2014 LAURENT THIEBAUT & OLIVIA MERLE"
  #else
    #define COMPILEOPTION_INVENTORY_DEMOCONTENT 0
    #define COMPILEOPTION_ALLOWSAVE 1
    #define COMPILEOPTION_ALLOWSAVEPLAYERSTATE 1
    #define COMPILEOPTION_ALLOWVEHICLE 1
    #define COMPILEOPTION_VERSIONSTRING "VERSION 1.36 (c) 2014 LAURENT THIEBAUT & OLIVIA MERLE"
  #endif
#else
  #define COMPILEOPTION_INVENTORY_DEMOCONTENT 0
  #define COMPILEOPTION_ALLOWSAVE 0
  #define COMPILEOPTION_ALLOWSAVEPLAYERSTATE 0
  #define COMPILEOPTION_ALLOWVEHICLE 1
  #define COMPILEOPTION_VERSIONSTRING "VERSION 1.36 : CONFIDENTIAL TESTING (c) LAURENT THIEBAUT & OLIVIA MERLE"
#endif
